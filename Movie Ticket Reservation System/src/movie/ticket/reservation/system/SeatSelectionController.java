...
public class SeatSelectionController implements Initializable {
    ...
    @FXML
    private void comboBoxSelectionChanged(ActionEvent event) {
    ...
    private void saveSeatsToFile() {
        ...
        try {
            ...
            for (int i = 0; i < theaters.length; i++) {
                filename = "C:/Users/Thomas/Documents/RetroCinemas/" + 
    ...
    @FXML
    private void clickGoBackBtn(ActionEvent event) {
        ...
        try {
            ...
            // on to the controller called FXMLDocument.fxml
            ...
            // The code within this finally block makes sure that any
            // "Selected" seats that were chosen while the user clicked
            // to go back to the movie selection are reset back to "Open".
